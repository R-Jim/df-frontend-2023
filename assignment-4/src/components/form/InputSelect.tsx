...
function InputSelect(params: InputSelectProp) {
    ...
    return (
        <div className="input-container">
            ...
            <select name={params.name} onChange={params.onChange} value={params.value} {...attributes} className='border-border-color w-full box-border px-2.5 py-[8.25px] rounded-[5px] border-[1.5px] border-solid'>
                {optionsRender}
            </select>
        </div>
    )
